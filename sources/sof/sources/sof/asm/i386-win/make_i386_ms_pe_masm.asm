...
sof_make_context PROC EXPORT
    mov  eax,         [esp+04h]     ; load 1. arg of sof_make_context, pointer to context stack (base)
    ...
    mov  ecx,         [esp+04h]     ; load 1. arg of sof_make_context, pointer to context stack (base)
    mov  [eax+018h],  ecx           ; save address of context stack (base) in fcontext_t
    mov  edx,         [esp+08h]     ; load 2. arg of sof_make_context, context stack size
    ...
    mov  ecx,         [esp+0ch]     ; load 3. arg of sof_make_context, pointer to context function
