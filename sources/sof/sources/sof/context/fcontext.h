...
#ifdef WIN32
#       ifdef _WIN64
#               include <sof/context/fcontext_x86_64_win.h>
#       else
#               include <sof/context/fcontext_i386_win.h>
#       endif
#else
#       if defined(__x86_64__) || defined(__x86_64) || defined(__amd64__) || defined(__amd64) || defined(_M_X64) || defined(_M_AMD64)
#               include<sof/context/fcontext_x86_64_elf.h>
...
#               include<sof/context/fcontext_ppc.h>
#       elif defined(__sparc__) || defined(__sparc)
#               include<sof/context/fcontext_sparc.h>
#       else
...
SOF_API intptr_t sof_context_jump( sof_context_t * ofc, sof_context_t const* nfc, intptr_t vp, bool preserve_fpu = true);

SOF_API sof_context_t* sof_make_context( void * sp, size_t size, void (* fn)( intptr_t) );
